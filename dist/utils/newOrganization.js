...
exports.newOrganization = void 0;
const prisma_1 = require("../lib/prisma");
const md5_1 = __importDefault(require("md5"));
const sendEmail_1 = require("./sendEmail");
const newOrganization = async (tenant, user) => {
    const prisma = (0, prisma_1.getPrismaClient)(tenant);
    try {
        const passwordHash = (0, md5_1.default)(user.password);
        ...
        const html = `
            ...
            `;
        (0, sendEmail_1.sendEmail)(user.email, subject, html);
